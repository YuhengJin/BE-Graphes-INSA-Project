...
public class DijsktraSenarios {
	...
	@Test
	public void	Scenario2() throws IOException { // Test sur tous les chemins en longueur
	initAll();
	for (int i=0;i<20;i++)
	{
		for (int j=0; j<20;j++)
	...
	@Test
	public void	Scenario3() throws IOException { // Test sur tous les chemins en temps de parcours
	initAll();
	for (int i=0;i<20;i++)
	{
		for (int j=0; j<20;j++)
